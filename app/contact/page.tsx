            ...
            <FadeInSection>
              <div>
                ...
                <p className='text-gray-600 mb-8'>
                  At Talent Tree Recruits, we connect top talent with top
                  companies. Whether you're hiring or job hunting, our team is
                  here to make the process smooth, fast, and effective. Reach
                  out today and take the next step with confidence.
                </p>
                <p className='text-gray-700 mb-7'>
                  <strong>Looking to hire or apply?</strong> Fill out our
                  contact form or send us your resume directly — we’ll take it
                  from there.
                </p>
                  ...
                  <div className='flex items-start'>
                    ...
                    <div>
                      ...
                      <p className='text-gray-600'>
                        <a
                          href='mailto:abhijeet021097@gmail.com'
