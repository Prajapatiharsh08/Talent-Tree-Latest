...
import { submitContactRequest, resetContactForm } from "@/lib/redux/reducers/contactReducer"
          ...
          <FadeInSection>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-blue-100 mb-8">
                Have questions about our services or looking for career opportunities? We're here to help.
              </p>
            </div>
          </FadeInSection>
        </div>
            ...
            <FadeInSection>
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  At Talent Tree Recruits, we connect top talent with top companies. Whether you're hiring or job
                  hunting, our team is here to make the process smooth, fast, and effective. Reach out today and take
                  the next step with confidence.
                </p>
                <p className="text-gray-700 mb-7">
                  <strong>Looking to hire or apply?</strong> Fill out our contact form or send us your resume directly —
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-blue-900 mb-1">Our Office</h3>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="mailto:abhijeet021097@gmail.com" className="hover:text-blue-700 transition-colors">
                          abhijeet021097@gmail.com
                        </a>
                      </p>
                      {/* <p className='text-gray-600'>
                        <a
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="tel:+12125551234" className="hover:text-blue-700 transition-colors">
                          +91 76218-54306
                        </a>
                      </p>
                      {/* <p className='text-gray-600'>
                ...
                <div className="mt-12">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-sm">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <p className="font-medium text-blue-900">Monday - Friday</p>
              ...
              <div className="bg-white rounded-xl shadow-sm p-8">
                {success ? (
                  <div className="bg-green-50 border border-green-200 rounded-xl p-8 text-center">
                    ...
                    <Button onClick={() => dispatch(resetContactForm())}>Send Another Message</Button>
                  </div>
                ) : (
                  <>
          ...
          <FadeInSection>
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                We're conveniently located in the heart of New York City. Feel free to stop by during our office hours.
              </p>
            </div>
          </FadeInSection>
